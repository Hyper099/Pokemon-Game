...
public class Fight {
    ...
    private int LevelUpTech(String playerPokemonName, int playerPokemonLvl, int playerPokemonTotalExp,
            int playerPokemonNextLvl, int computerPokemonExpGiven) {
        ...
        if (leftoverExp >= 0) {
            ...
            System.out.println("Congratulations your " + playerPokemonName + " has leveled up!, It's level is now "
